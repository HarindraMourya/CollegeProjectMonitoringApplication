...
<h4>
<s:property value="getText('login.message')"/> ${sessionScope.admin} 
</h4>
<h4><s:property value="facultyMessege"/>  </h4>
<h4><s:property value="mailMessage"/>  </h4>
<h4><s:property value="techerMessege"/>  </h4>
</p>
</div>
<!-- left menu starts -->
<div class="container" id="dash">
    <div class="row">
            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li><a  href="#" onclick="showInbox()"><span><i class="glyphicon glyphicon-inbox"></i> <s:property value="getText('mail.inbox')"/><span class="badge"><s:property value="adminMailCount"/></span></span></a>
                        
                        </li>

                        <li><a  href="#" onclick="faculty()"><span><i class="glyphicon glyphicon-plus"></i> <s:property value="getText('admin.addsingle')"/></span></a></li>
                        <li><a  href="#" onclick="mutipleFaculty()"><span><i class="glyphicon glyphicon-plus"></i> <s:property value="getText('admin.addmultiple')"/></span></a></li>


                        <li><a  href="facultyDetails.action" ><span><i class="glyphicon glyphicon-info-sign"></i> <s:property value="getText('admin.facultydetails')"/></span></a>
                        </li>
                        <li><a href="studentDetails.action" ><span><i class="glyphicon glyphicon-info-sign"></i> <s:property value="getText('admin.studentdetails')"/></span></a>
                        </li>
        ...
        <div class="col-sm-10 col-lg-10">
         ...
         <div class="col-sm-10 col-lg-10">
            <div ng-include="'adminMail.jsp'" id="mailbox"></div>
        </div> 
